    ...
    return (
        ...
        <section>
            ...
            <div
                ...
                style={{
                    backgroundImage: `linear-gradient(rgba(0,0,0,0.57), rgba(0,0,0,0.57)), url(${bg2})`,
                }}
            >
                ...
                {cards.map((_, index) => (
                    ...
                    <div className='w-full sm:w-1/2 lg:w-1/3 px-2 mb-6  flex justify-center'>
                        <div className='max-w-[424px] max-h-[567px] bg-white rounded-[30px] border border-[rgba(0,0,0,0.2)] hover:border-white hover:bg-white hover:shadow-[2px_9px_32px_0px_rgba(0,0,0,0.16)] shadow-[2px_9px_32px_0px_rgba(0,0,0,0.06)]'>
                            <img
                                className="
    pt-[35px] pl-[43px] pr-[43px]
    max-md:pt-[25px] max-md:pl-[30px] max-md:pr-[30px]
  ...
  "
                            ...
                            <div className='pl-[43px] pt-[21px] max-md:pl-[30px]'>
                                ...
                                <div className=' gap-[17px] flex flex-col pb-3'>
                                    ...
                                    {/* <Button text="Go Check" className='font-Poppins font-semibold text-[16px] leading-[150%] tracking-normal text-white bg-[rgba(44,73,254,1)]   w-[134px] h-[46px]  top-[491px] left-[45px] opacity-100 rounded-[23px] px-7 py-[11px] gap-2.5 mt-8 mb-[30px]  duration-500    transition-transform     active:scale-75 ' /> */}
                                    <Button
                                        text="Go Check"
                                        className="
    font-Poppins font-semibold text-[16px] leading-[150%] tracking-normal
    text-white
    bg-[rgba(44,73,254,1)]
    w-[134px] h-[46px]
    rounded-[23px]
